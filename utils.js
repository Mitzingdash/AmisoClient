...
class Utils {
	...
	static init() {
		...
		switch(Utils.getOsName()) {
			case "linux":
				Utils.minecraftDirectory += "/.config/Amiso Client";
				Utils.legacyDirectory += "/.config/parrotclient";
				break;
			case "osx":
				Utils.minecraftDirectory += "/Library/Application Support/Amiso Client";
				Utils.legacyDirectory += "/Library/Application Support/parrotclient";
				break;
			case "windows":
				Utils.minecraftDirectory += "/AppData/Roaming/Amiso Client";
